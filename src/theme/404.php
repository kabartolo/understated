		...
		<main id="main" class="site-main">
			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					...
					${{ theme.prefix }}_archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', '{{ theme.slug }}' ), convert_smilies( ':)' ) ) . '</p>';
					the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>${{ theme.prefix }}_archive_content" );
