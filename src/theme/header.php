...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			${{ theme.prefix }}_description = get_bloginfo( 'description', 'display' );
			if ( ${{ theme.prefix }}_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo ${{ theme.prefix }}_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
